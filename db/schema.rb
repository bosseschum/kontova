...
ActiveRecord::Schema[8.1].define(version: 2026_06_23_145808) do
  ...
  create_table "guest_accesses", force: :cascade do |t|
    t.datetime "created_at", null: false
    ...
    t.string "pin"
    t.datetime "updated_at", null: false
    t.index ["organization_id"], name: "index_guest_accesses_on_organization_id"
  end
  ...
  add_foreign_key "guest_accesses", "organizations"
